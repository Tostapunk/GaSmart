...
class _StatsScreenState extends State<StatsScreen> {
  ...
  //     DateTime.now().year, DateTime.now().month, DateTime.now().lastDayOfMonth);
  List<FlSpot> points1 = [];
  List<FlSpot> points2 = [];

  Future<int> selectMonth(BuildContext context, DateTime d) async {
                          ...
                          decoration: InputDecoration(
                            suffixIcon: IconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  setState(() {
                                    firstDate = DateTime(
                                        firstDate.year, d, firstDate.day);
                                    _loadSpese();
                                  });
                                }),
...
Future<void> openFullscreenDialog(BuildContext context) {
  ...
  // textController1.text = amount.toString();
  // textController2.text = liters.toString();
